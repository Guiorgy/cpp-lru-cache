...
template<typename key_t, typename value_t, const size_t max_size, const bool preallocate = false>
class lru_cache final : private lru_cache_base<key_t, value_t, max_size, preallocate> {
	static_assert(max_size > 0u);

	typedef typename lru_cache_storage_base<key_t, value_t, max_size>::key_value_pair_t key_value_pair_t;

public:
	typedef typename lru_cache_storage_base<key_t, value_t, max_size>::list_iterator_t list_iterator_t;
	typedef typename lru_cache_storage_base<key_t, value_t, max_size>::list_reverse_iterator_t list_reverse_iterator_t;
	typedef typename lru_cache_storage_base<key_t, value_t, max_size>::list_const_iterator_t list_const_iterator_t;
	typedef typename lru_cache_storage_base<key_t, value_t, max_size>::list_const_reverse_iterator_t list_const_reverse_iterator_t;
