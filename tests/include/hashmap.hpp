...
// Use the correct headers and type for the selected implementation
	...
	#define LRU_CACHE_HASH_MAP_TYPE std::unordered_map
	...
	#include <unordered_map>
	#define LRU_CACHE_HASH_MAP_TYPE std::pmr::unordered_map
	...
	#define LRU_CACHE_HASH_MAP_TYPE absl::flat_hash_map
	...
	#define LRU_CACHE_HASH_MAP_TYPE tsl::sparse_map
	...
	#define LRU_CACHE_HASH_MAP_TYPE tsl::robin_map
	...
	#define LRU_CACHE_HASH_MAP_TYPE tsl::hopscotch_map
	...
	#define LRU_CACHE_HASH_MAP_TYPE ankerl::unordered_dense::map
	...
	// Ankerl ankerl::unordered_dense::segmented_map
	#include "ankerl/unordered_dense.h"
	#define LRU_CACHE_HASH_MAP_TYPE ankerl::unordered_dense::segmented_map
...
template<
	...
	typename hash_function = guiorgy::detail::DefaultHashFunction<key_type>,
	typename key_equality_predicate = guiorgy::detail::DefaultKeyEqualityPredicate<key_type>,
	typename... other_args
>
using test_lru_cache = guiorgy::lru_cache<
	key_type,
	value_type,
	max_size,
	LRU_CACHE_HASH_MAP_TYPE,
	hash_function,
